...
export class NotEqualResultCondition implements ResultCondition {
    public type: ResultConditionType = ResultConditionType.NotEqual;
    public conditionOne: any;
    public conditionTwo: any;
    public convertToString: boolean = true;

    constructor(conditionOne: any = null, conditionTwo: any = null, convertToString: boolean = true, instanceData?: NotEqualResultCondition) {
    ...
    private deserialize(instanceData: NotEqualResultCondition) {
    ...
    checkCondition(data: Dictionary<string>): boolean {
        let shallowClone: NotEqualResultCondition = <NotEqualResultCondition>Object.assign(new NotEqualResultCondition(), this);
